...
from stock_registry import STOCK_UNIVERSE, daily_csv_path


def export_daily_history(stock):
    ...
    price_df = ticker.history(period="10y", interval="1d", auto_adjust=False).reset_index()
    ...
    output_path = daily_csv_path(stock_name)
