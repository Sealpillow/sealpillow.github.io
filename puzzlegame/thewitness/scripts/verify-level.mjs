...
//
// Examples:
//   node scripts/verify-level.mjs src/puzzles/levels.json
//   node scripts/verify-level.mjs src/puzzles/levels.json --mode blocked-edges
//   node scripts/verify-level.mjs src/puzzles/levels.json --mode blocked-edges --only level_050
//   node scripts/verify-level.mjs src/puzzles/levels.json --json-out out.json --md-out out.md
